    ...
    for (i = 0; i < all_course_data.length; i++)
    {
        ...
        <div>
            <div class=\"list_element background_color\"> 
                <a id=\"course_number` + i + `\" class=\"list_link center_text_verticle title_size\" href=\"./Viewer.html?course=` + all_course_data[i].Prefix + all_course_data[i].Course_Number + `\" onclick=\"store_course(` + i + `);\">` + all_course_data[i].Prefix + ` ` + all_course_data[i].Course_Number + `: ` + all_course_data[i].Course_Name + ` (` + all_course_data[i].Credit_Hours + ` Credit Hours)</a>
